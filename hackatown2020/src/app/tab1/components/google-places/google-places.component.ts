...
export class GooglePlacesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.mapsAPILoader.load().then(() => {
      ...
      let toAutocomplete = new google.maps.places.Autocomplete(this.toAddressRef.nativeElement, {
        types: ["address"]
      });

      let fromAutoComplete = new google.maps.places.Autocomplete(this.fromAddressRef.nativeElement, {
        types: ["address"]
      });
